...
import ubel from "@asset/ubel.png";
...
<template>
  <Layouts.ErrorFallbackLayout
    ...
    :message="t('page.conflict.message')"
    :cause="t('page.conflict.cause')"
  >
    <span
    ...
    <span class="place-self-center">
      <img
        :src="ubel"
        :alt="t('page.conflict.imageAlt')"
        class="w-24 sm:w-40 h-24 sm:h-40 object-cover rounded-full shadow-lg border-4 border-green-900"
      />
    </span>
    <span

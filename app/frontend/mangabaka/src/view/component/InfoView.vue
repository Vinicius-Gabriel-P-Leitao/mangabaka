    ...
    >
        ...
        <transition name="fade">
            <div
                v-if="show"
                :class="[
                    'absolute -translate-x-1/2 left-1/2 z-50 inline-block text-xs rounded w-fit h-fit p-1 select-none whitespace-nowrap shadow-lg',
                    'text-[#1a1a1a] dark:text-white bg-[#f4f4f5] dark:bg-[#1a1a1a] transform',
